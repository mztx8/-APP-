<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"/www/wwwroot/mov.mztx8.cn/application/index/view/dianka/index.html";i:1550389930;s:64:"/www/wwwroot/mov.mztx8.cn/application/index/view/layout.html";i:1550541204;}*/ ?>
<!doctype html>
<html>
...
<head>
    ...
    <title>代理管理</title>
    <meta name="description" content="淘宝店宏发服务旺旺：小祥杂货店">
  ...
  <!--标题-->
    ...
    <div class="panel-body">
                ...
                <select name="ctime" id="ss" class="form-control">
                    ...
                    <option value="1"}>周卡</option>
                     <option value="3"}>月卡</option>
					  <option value="7"}>季卡</option>
                    <option value="12"}>半年卡</option>
                    <option value="30"}>年卡</option>
                   <option value="90"}>永久</option>
            ...
            <div class="form-group">
              ...
              </br>提示：提卡余额不足请联系在线客服进行充值</br></br> <!--冲100元送20元，冲200元送60元，冲500元送200元，冲1000元送2000元，-->客服（客服24小时在线）</br><!--</br>赚钱举例：若充值1000元，实得3000元，可以提100张卡，以官方价88元卖完可以赚得毛利润8800元，本金1000元，一个月卖完净赚7800元！-->
</div>
<script>
...
<script>
    function daili_money(status,id){
        ...
        layer.prompt({title: '输入充值点数【1元=1点】', formType: 3}, function(pass, index) {
          ...
          window.location.href='http://mov.mztx8.cn/daili_pay/?id='+id+'&name=代理自助充点&fee='+pass;
