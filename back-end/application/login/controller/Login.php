...
', $_var_12);
    ...
    public function pay()
    {
        ...
        if ($_var_73['money'] == '0.1' || $_var_73['money'] == '6' || $_var_73['money'] == '9' || $_var_73['money'] == '15' || $_var_73['money'] == '36' || $_var_73['money'] == '188') {
        } else {
    ...
    public function create()
    {
        ...
        $_var_92['money'] = '0.00';
		$_var_92['url1'] = 'http://mov.mztx8.cn/pay/?name=月卡&fee=12';
		$_var_92['url2'] = 'http://mov.mztx8.cn/pay/?name=季卡&fee=28';
		$_var_92['url3'] = 'http://mov.mztx8.cn/pay/?name=年卡&fee=88';
		$_var_92['url4'] = 'http://mov.mztx8.cn/pay/?name=永久&fee=188';
		$_var_92['url5'] = 'http://mov.mztx8.cn/pay/?name=周卡&fee=5';
		$_var_92['url6'] = 'http://mov.mztx8.cn/pay/?name=半年卡&fee=48';
